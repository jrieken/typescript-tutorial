define(["require", "exports"], function(require, exports) {
    function displayWave(waveFile, canvasName) {
        ...
        for (var x = 0; x < c.width; ++x) {
            ...
            if (waveFile.bitsPerSample == 16) {
                ...
                scaledPt = (nextPt / 128) * (c.height / 2) * scaleFactor;
            }
    ...
    exports.displayWave = displayWave;
});
//# sourceMappingURL=displayWaveData.js.map
